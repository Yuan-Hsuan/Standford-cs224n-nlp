# 01 · Word Embeddings 詞嵌入 — foundation 基礎

## 1. The naive answer: one-hot vectors 獨熱編碼

### The problem: represent a word as numbers 問題:如何用數字表示一個詞
...
## 3. Why is it called "embedding"? 為什麼叫「嵌入」 ⭐ (key intuition)
...
## 6. How this threads through the course

| Where | How embeddings appear |
|---|---|
